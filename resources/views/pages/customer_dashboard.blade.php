        ...
        <div class="col-md-9 venue-list animate__animated animate__fadeIn">
            ...
            <div class="venue-title mb-0">
                ...
                <!-- <div class="mt-2 d-flex flex-wrap gap-2">
                    <span class="badge">Jakarta <i class="bi bi-x ms-1"></i></span>
                    <span class="badge">10 Des <i class="bi bi-x ms-1"></i></span>
                    <span class="badge">50 Tamu <i class="bi bi-x ms-1"></i></span>
                    <span class="badge">Pernikahan <i class="bi bi-x ms-1"></i></span>
                </div> -->
            </div>
